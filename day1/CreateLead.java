...
public class CreateLead {
	public static void main(String[] args) 
	{
		...
		driver.findElement(By.id("createLeadForm_description")).sendKeys("6+ Yrs");
		
		driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("somumce.ece07@gmail.com");
